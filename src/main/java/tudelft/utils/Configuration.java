...
public class Configuration implements Serializable
{
	...
	{	
		try
		{
			...
			localInputFolder = document.getElementsByTagName("localInputFolder").item(0).getTextContent();
			localOutputFolder = document.getElementsByTagName("localOutputFolder").item(0).getTextContent();
			nameNodeUrl = document.getElementsByTagName("nameNodeUrl").item(0).getTextContent();
	...
	public void print()
	{
		...
		System.out.println("localOutputFolder:\t" + localOutputFolder);
		System.out.println("nameNodeUrl:\t" + nameNodeUrl);
		System.out.println("*************************");
	}
}